...
wget http://gdac.broadinstitute.org/runs/stddata__2016_01_28/data/LAML/20160128/gdac.broadinstitute.org_LAML.Merge_methylation__humanmethylation450__jhu_usc_edu__Level_3__within_bioassay_data_set_function__data.Level_3.2016012800.0.0.tar.gz -O methylation_hm450.tar.gz
mkdir methylationHM450
tar xzf methylation_hm45.tar.gz -C methylationHM450 --strip-components 1 &&
rm methylation_hm450.tar.gz
