...
distance <- 'euclidean'
method <- 'ward.D2'
imagefolder <- '../../data/180307_M/HM450/moduleNetworkFigMcentered'
datafolder <- '../../data/180307_M/HM450/resultsMcentered'
...
RunModel(data.HM450, RNAseq, imagefolder, datafolder, convert2M=convert2M, subsetProbes=subsetProbes, distance=distance, method=method, 
         cutoff=cutoff, percent.test=percent.test, alpha=alpha, centered=centered)

convert2M <- F
imagefolder <- '../../data/180307_M/HM450/moduleNetworkFigBcentered'
datafolder <- '../../data/180307_M/HM450/resultsBcentered'
